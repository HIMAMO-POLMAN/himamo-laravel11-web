...
@section('meta_description', 'Hubungi kami melalui media sosial, email, atau formulir kontak untuk pertanyaan dan
    informasi lebih lanjut tentang HIMAMO.')
@section('content')
                                ...
                                <div class="w-100 text-center">
                                    ...
                                    <div class="pt-4 text">
                                        <p><span>LinkedIn: </span>
                                            <a target="_blank" href="https://www.linkedin.com/company/himamo/">HIMAMO</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="media-embed-box">
                                        <blockquote class="tiktok-embed w-100 h-100"
                                            cite="https://www.tiktok.com/@himamo_official" data-unique-id="himamo_official"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mt-2 col-sm-12">
                                                <div class="form-group pt-4">
                                                    <input onClick="return empty()" type="submit" value="Kirim Pesan"
        ...
        form.addEventListener('submit', e => {
            ...
            fetch(scriptURL, {
                ...
                .catch(error => {
                    ...
                    Swal.fire({
                        title: 'Kesalahan!',
                        text: 'Terjadi kesalahan saat mengirim. Coba lagi nanti.',
                        icon: 'error',
                        confirmButtonText: 'Kembali',
                        confirmButtonColor: '#028784'
                    });
