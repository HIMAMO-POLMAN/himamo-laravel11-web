...
@section('content')
    ...
    <div class="d-flex card shadow p-3">
        ...
        <div class="card-body">
            <form action="{{ route('ae-library.store') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-12 col-md-6 mb-3">
                        <label for="memberNumber" class="form-label">Judul <span class="text-danger">*</span></label>
                        <input type="text" id="memberNumber" name="title" value="{{ old('title') }}"
                    ...
                    <div class="col-12 col-md-6 mb-3">
                        ...
                        <input type="number" id="name" name="isbn" value="{{ old('isbn') }}"
                ...
                <div class="row">
                    <div class="col-12 col-md-6 mb-3">
                        ...
                        <input type="text" id="memberNumber" name="penulis" value="{{ old('penulis') }}"
                    ...
                    <div class="col-12 col-md-6 mb-3">
                        ...
                        <input type="text" id="name" name="penerbit" value="{{ old('penerbit') }}"
                ...
                <div class="row">
                    <div class="col-12 col-md-6 mb-3">
                        ...
                        <input type="number" id="memberNumber" value="{{ old('tahun_terbit') }}" name="tahun_terbit"
                    ...
                    <div class="col-12 col-md-6 mb-3">
                        ...
                        <input type="text" id="name" name="bahasa" value="{{ old('bahasa') }}"
