            ...
            <form action="{{ route('ae-library.update', $pustaka->slug) }}" method="POST">
                ...
                <div class="row g-2">
                    ...
                    <div class="col mb-3">
                        ...
                        <input type="number" id="name" name="isbn" value="{{ old('isbn', $pustaka->isbn) }}"
                            class="form-control  @error('isbn') is-invalid @enderror" placeholder="123456" />
                        @error('isbn')
                            <span class="text-danger">
                                {{ $message }}
                            </span>
                ...
                <div class="row g-2">
                    <div class="col mb-3">
                        ...
                        <input type="text" id="memberNumber" name="penulis"
                            value="{{ old('penulis', $pustaka->penulis) }}"
                    ...
                    <div class="col mb-3">
                        ...
                        <input type="text" id="name" name="penerbit"
                            value="{{ old('penerbit', $pustaka->penerbit) }}"
                            class="form-control @error('penerbit') is-invalid @enderror" placeholder="Masukan Penerbit" />
                        @error('penerbit')
                            <span class="text-danger">
                                {{ $message }}
                            </span>
                ...
                <div class="row g-2">
                    <div class="col mb-3">
                        ...
                        <input type="number" id="memberNumber" value="{{ old('tahun_terbit', $pustaka->tahun_terbit) }}"
                            name="tahun_terbit" class="form-control @error('tahun_terbit') is-invalid @enderror"
                ...
                <div class="col mb-3">
                    ...
                    <input type="text" id="name" name="cover" value="{{ old('cover', $pustaka->cover) }}"
